...
namespace Imp\Framework\Component\Database\Mysql;

/**
 * Class Mysql
 * @package Imp\Framework\Component\Database\Mysql
 */
class Mysql extends MysqlBase
{
    ...
    public function __construct($config = array())
    {
        ...
        $this->_tablePrefix = $config->getTablePrex();
        $this->connect($config->getHost(), $config->getPort(), $config->getDbName(), $config->getUser(), $config->getPass());
    }
    ...
    {
        $this->_link->set_charset($this->_config->getCharset());
    }
    ...
    public function query($sql)
    {
        ...
        try {
            ...
            if ($this->_query === false) {
                ...
                echo "[error]mysql error:" . $this->getError() . "\r\n<Br>\r\n";
                die($sql);
    ...
    protected function _fetchArray($type = MYSQLI_ASSOC)
    {
        ...
        if ($result_type == 'object') {
            return $this->_query->fetch_object('Mframework\Component\Database\ResultSet'); // resultSet
